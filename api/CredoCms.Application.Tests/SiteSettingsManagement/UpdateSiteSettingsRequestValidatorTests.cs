...
public sealed class UpdateSiteSettingsRequestValidatorTests
{
    ...
    private static UpdateSiteSettingsRequest Valid() => new(
        ...
        EventCategoriesJson: "[\"Worship\",\"Formation\"]",
        NewsCategoriesJson: "[\"Preachers Notes\",\"Announcements\",\"Stories\"]",
        DocumentCategoriesJson: "[\"Bulletins\",\"Forms\"]",
        SermonContextsJson: "[\"AM Worship\",\"AM Bible Class\",\"PM Worship\",\"Wednesday Night\"]",

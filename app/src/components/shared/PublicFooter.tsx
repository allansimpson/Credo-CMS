        ...
        <div>
          ...
          <ul className="mt-2 flex gap-4">
            {settings.facebookUrl && (
              <li>
                <a href={settings.facebookUrl} aria-label="Facebook" className="text-muted-foreground hover:text-primary">
            ...
            {settings.instagramUrl && (
              <li>
                <a href={settings.instagramUrl} aria-label="Instagram" className="text-muted-foreground hover:text-primary">
            ...
            {settings.youTubeUrl && (
              <li>
                <a href={settings.youTubeUrl} aria-label="YouTube" className="text-muted-foreground hover:text-primary">
            ...
            {settings.otherSocialUrl && settings.otherSocialLabel && (
              <li>
                <a href={settings.otherSocialUrl} className="text-sm text-muted-foreground hover:text-primary">

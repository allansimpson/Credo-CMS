...
public sealed class EventService : IEventService
{
    ...
    public async Task<EventOperationResult> CreateAsync(CreateEventRequest request, CancellationToken ct = default)
    {
        ...
        {
            Id = Guid.NewGuid(),
            Slug = request.Slug, Title = request.Title, DescriptionJson = request.DescriptionJson,
            StartsAt = request.StartsAt, EndsAt = request.EndsAt, AllDay = request.AllDay,
            Location = request.Location,
            HeroImageUrl = request.HeroImageUrl, HeroImageWebpUrl = request.HeroImageWebpUrl, HeroImageAlt = request.HeroImageAlt,
            Visibility = request.Visibility,
            RecurrenceRule = request.RecurrenceRule,
            RecurrenceEndDate = request.RecurrenceEndDate,
            RecurrenceCount = request.RecurrenceCount,
            RegistrationMode = request.RegistrationMode,
            Capacity = request.Capacity, WaitlistEnabled = request.WaitlistEnabled,

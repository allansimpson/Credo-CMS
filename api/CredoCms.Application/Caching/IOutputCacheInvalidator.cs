...
public static class OutputCacheTags
{
    ...
    // Broadcast-stats are short-cached (30s) so the admin detail page
    // reflects webhook-driven counters without re-querying the DB on
    // every refresh. Webhook events evict by tag.
